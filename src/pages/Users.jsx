...
//         />
//         <Button onClick={() => openModal()} className="rounded-lg px-6 w-full sm:w-auto bg-purple-600 hover:bg-purple-700 text-white">
//           + Add User
//         </Button>
//       </div>
...
//           <DialogFooter className="mt-4">
//             <Button onClick={handleSave} className="rounded-lg px-6 bg-purple-600 hover:bg-purple-700 text-white">
//               {editingUser ? "Update User" : "Save User"}
//             </Button>
//           </DialogFooter>
//         </DialogContent>
...
//       {/* Table */}
//       {/* <div className="rounded-xl border overflow-x-auto shadow-sm w-full">
...
//                   <TableCell className="px-4 py-3">{u.phone}</TableCell>
