  ...
  return (
    <div className='space-y-6 w-full px-2 sm:px-4 bg-[#E5E5E5] min-h-screen py-6'>
          ...
          {loading ? (
            ...
            <TableBody>
              {paginatedUsers.length > 0 ? (
                ...
                <TableRow>
                  <TableCell colSpan={7} className='text-center py-6 text-gray-300'>
                    No users found.
                  </TableCell>
                </TableRow>
              )}
      ...
      {selectedUsers.length > 0 && (
        <div className="flex items-center justify-between mt-4 p-3 bg-[#0f192f] text-white rounded-lg">
          <span>{selectedUsers.length} selected</span>
          <div className="flex gap-3">
            <Button
              variant="outline"
              onClick={clearSelection}
              className="rounded-lg bg-gray-200 text-[#14213D] cursor-pointer"
            >
              Cancel
            </Button>
            <Button
              onClick={handleBulkDelete}
              className="rounded-lg bg-white text-black hover:bg-[#152a56] hover:text-white cursor-pointer"
            >
              Delete
            </Button>
          </div>
